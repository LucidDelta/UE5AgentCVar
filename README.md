...
> Don't have a C++ project? Add an empty C++ class through **Tools → New C++ Class** first, then come back to step 1. The editor needs a C++ pipeline to compile plugins.
...
4. Pick a model — `claude-haiku-4-5-…` is fast and cheap, well-suited for this.
